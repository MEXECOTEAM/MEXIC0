...
#!/usr/bin/env bash
cd $(cd $(dirname $0); pwd)
if ! screen -list | grep -q "MEXIC0"; then
screen -S MEXIC0 lua ./inc/BOT.lua
fi
screen -X -S MEXIC0 kill
screen -S MEXIC0 lua ./inc/BOT.lua
]])
file:close()
...
..'\27[0;31m'..[[¦ Dev : @ZAHAYMR]]..'\27[m\27[0;32m\n\n\027[0;32m'   
